...
class MyBookedTicketController extends Controller
{
    ...
    public function indexDetail(Request $request){
        ...
        return view('visitor-pages.pages.booking.pesanan.detail-pesanan', ['pesananTiket'=> $pesananTiket,'destination' => $pesananTiket->tikets->first()->tipe_tiket->first()->tempat_wisata]);
    }
}
